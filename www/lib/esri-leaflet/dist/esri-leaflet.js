  ...
  "undefined" != typeof window && window.L && (window.L.esri = EsriLeaflet),
    ...
    function(a) {
      ...
      a.Layers.BasemapLayer = L.TileLayer.extend({
        ...
        onRemove: function(a) {
          !a._hasEsriLogo && this._logo && this._logo._container && (a.removeControl(this._logo), a._hasEsriLogo = !1), L.TileLayer.prototype.onRemove.call(this, a), a.off("moveend", this._updateMapAttribution, this)
        },
    ...
    function(a) {
      ...
      a.Layers.FeatureManager = a.Layers.FeatureGrid.extend({
        ...
        _requestFeatures: function(b, c, d) {
          this._activeRequests++, 1 === this._activeRequests && this.fire("loading", {
            ...
            g && g.exceededTransferLimit && this.fire("drawlimitexceeded"), !e && f && f.features.length && !this._removed && a.Util.requestAnimationFrame(L.Util.bind(function() {
      ...
      onAdd: function(a) {
        ...
        }, this), this._removed = !1, EsriLeaflet.Layers.FeatureManager.prototype.onAdd.call(this, a)
      },
      onRemove: function(a) {
        this._removed = !0;
